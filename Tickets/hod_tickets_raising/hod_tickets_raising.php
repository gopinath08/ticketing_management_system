...
<td>
	...
	<td>
<?php if($empdetails['tickets_status'] ==0){?><button class="btn btn-light btn-sm" data-id="<?php echo $empdetails['ticket_id']; ?>" onclick="tickets_view(<?php echo $empdetails['ticket_id']; ?>)"><i class="fa fa-eye"></i> </button><?php } ?>
<?php if($empdetails['tickets_status'] ==1 || $empdetails['tickets_status'] ==2 || $empdetails['tickets_status'] ==3){?><button class="btn btn-light btn-sm" data-id="<?php echo $empdetails['ticket_id']; ?>" onclick="view(<?php echo $empdetails['ticket_id']; ?>)"><i class="fa fa-eye"></i> </button><?php } ?>
...
function view(v){
	...
	$.ajax({
	type:"POST",
	url:"Tickets/hod_tickets_raising/view.php?id="+v,
	success:function(data)
	{
		$("#main_content").html(data);
	}
