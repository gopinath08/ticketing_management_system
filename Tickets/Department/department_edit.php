...
include("../../user.php");
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT * FROM `masters_department`
 where id='$id'"); 
$stmt->execute(); 
$row = $stmt->fetch();
?>
<div  class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><font size="5">DEPARTMENT EDIT</font></h3>
...
<form role="form" name="" action="" method="post" enctype="multipart/type">
 ...
 ?>
                ...
                <div class="card-footer">
                  <input type="button" class="btn btn-primary btn-md"  style="float:left;" name="Update" onclick="department_update()" value="Update"> 
 ...
 function department_update()
    ...
    url:'Tickets/Department/department_update.php',
    success:function(data)
    {
      if(data==1)
      { 
