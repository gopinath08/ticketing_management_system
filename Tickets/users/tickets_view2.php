...
include("../../user.php");
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT closed_tickets.closed_ticket_id,closed_tickets.end_date,closed_tickets.end_time,closed_tickets.start_date,closed_tickets.start_time,closed_tickets.closed_status,tickets.id as tickets_id,tickets.client_id,tickets.hod_id,tickets.subject,tickets.description,tickets.tickets_status,tickets.created_on,masters_project.Project_name,tickets.tickets_status,task_assign.due_date,task_assign.users_id,task_assign.hours FROM `task_assign` INNER JOIN tickets ON task_assign.Task_id=tickets.id INNER JOIN masters_project ON tickets.project_id=masters_project.id 
		...
		<div class="form-group row">
				...
				<div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" name="end_date" id="end_date" value="<?php echo  $row['end_date'];?>" readonly>
                  </div>
				  </div>
				    <div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" name="end_time" id="end_time" value="<?php echo  $row['end_time'];?>" readonly>
                  </div>
				  </div>
				<div class="form-group row">
                    ...
                    <div class="col-sm-4">
                      ...
                      <input type="text" class="form-control" name="end_time" id="end_time" value="closed" readonly>
                  </div>
				  </div>
