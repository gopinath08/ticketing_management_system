...
include("../../user.php");
$id=$_REQUEST['id'];
$stmt = $con->prepare("SELECT * FROM `role_master`
 where id='$id'"); 
$stmt->execute(); 
$row = $stmt->fetch();
?>
...
<div  class="card card-primary">
              <div class="card-header">
                <h3 class="card-title"><font size="5">ROLE EDIT</font></h3>
...
<form role="form" name="" action="" method="post" enctype="multipart/type">
                ...
                <div class="card-body">
				  ...
				  <div class="form-group row">
					...
					<input type="hidden" class="form-control" id="get_id" name="get_id" value="<?php echo  $row['id']; ?>">
                      <input type="text" class="form-control" name="name" id="name" value="<?php echo  $row['role_name'];?>" required>
                  </div>
				  </div>
 ...
 ?>
                ...
                <div class="card-footer">
                  <input type="button" class="btn btn-primary btn-md"  style="float:left;" name="Update" onclick="role_update()" value="Update" > 
