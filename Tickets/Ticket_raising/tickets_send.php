...
<td>
	...
	<td>
<button class="btn btn-light btn-sm" data-id="<?php echo $empdetails['ticket_id']; ?>" onclick="ticket_view(<?php echo $empdetails['ticket_id']; ?>)"><i class="fa fa-eye"></i> </button>
...
$cnt=$cnt+1;
 ...
 function ticket_view(v){
		//alert(v);
	$.ajax({
	type:"POST",
	url:"Tickets/Ticket_raising/tickets_view.php?id="+v,
